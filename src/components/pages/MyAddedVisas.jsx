...
const MyAddedVisas = () => {
    ...
    useEffect(() => {
        fetch(`https://assignment-10-server-phi-red.vercel.app/my-visas?added_by=${user.email}`)
            .then(res => res.json())
    ...
    const handleUpdate = (e) => {
        ...
        fetch(`https://assignment-10-server-phi-red.vercel.app/visa/${editingVisa._id}`, {
            method: 'PUT',
            headers: {
